...
import { Building2, Globe, GraduationCap, ChevronRight, ArrowLeft, Plus, Edit2, Trash2, X } from "lucide-react";
...
export default function DepartmentList() {
  ...
  const handleDomainClick = async (domain) => {
    ...
    try {
      ...
      toast.error("Failed to fetch domain experts");
    }
  };
      ...
      {!selectedDept ? (
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground">View Expert Students</p>
                    </div>
                    <ChevronRight className="h-5 w-5 text-slate-300" />
                  </div>
                </CardContent>
        ...
        <Card className="shadow-sm border border-border/50 bg-card">
          <CardHeader className="flex flex-row items-center gap-3 pb-2">
            ...
            <CardTitle className="text-xl font-bold">Student Experts Directory</CardTitle>
          </CardHeader>
          <CardContent className="overflow-x-auto">
            <Table className="min-w-[560px]">
              ...
              <TableBody>
                {students.length === 0 ? (
                  <TableRow><TableCell colSpan={4} className="text-center py-8 text-muted-foreground">No expert students found in this domain</TableCell></TableRow>
                ) : (
                  students.map((s) => (
                    <TableRow
                      key={s._id}
